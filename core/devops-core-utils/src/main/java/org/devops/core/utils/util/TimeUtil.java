...
public class TimeUtil {
    ...
    public final static long MINUTE_MILLISECONDS = 1000 * 60L;
    public final static long SCAN_LOG_INTERVAL = 1000 * 60L;
    public final static long HOUR_MILLISECONDS = MINUTE_MILLISECONDS * 60L;
    public final static long DAY_MILLISECONDS = HOUR_MILLISECONDS * 24L;
    private final static DateFormat fmt1 = new SimpleDateFormat("yyyy-MM-dd HH:mm");
    private final static DateFormat fmtDate = new SimpleDateFormat("yyyy-MM-dd");
    private final static DateFormat fmtSecond = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    ...
    public static String addMinutes(int m) {
        ...
        return from.format(new Date(date.getTime() + m * MINUTE_MILLISECONDS));
    }
    ...
    public static long getTime(String s) {
        Date date = parseMysql(s);
        if (date == null) {
            throw new CommonRuntimeException("转换日期出错");
        }
        return date.getTime();
    }
    ...
    public static long getSecondCa(String d1, String d2, String format) {
        Date date1 = toDate(d1, format);
        Date date2 = toDate(d2, format);
        if (date1 == null || date2 == null) {
            throw new CommonRuntimeException("日期转换出错:" + d1 + "," + d2);
        }
        return getSecondCa(date1, date2);
    }
    ...
    public static String addSecondCa(String d1, int timeSpan, String format) {
        ...
        if (d1Date == null) {
            throw new CommonRuntimeException("日期转换出错:" + d1);
        }
    ...
    public static boolean isThan(String d2) {
        ...
        if (d2Date == null) {
            throw new CommonRuntimeException("日期转换出错:" + d2);
        }
        if (d1Date.getTime() > d2Date.getTime())
            return true;
        return false;
    ...
    public static String getLastTimestamp(String start_time, String end_time) {
        ...
        if (start == null || end == null) {
            throw new CommonRuntimeException("日期转换出错:" + start_time + "," + end_time);
        }
...
//		buff.append("当前时间 <").append(c1.getTime().toLocaleString()).append(">,数据库时间 =<").append(c2.getTime().toLocaleString()).append(">");
    ...
    public static boolean isThanTime(String d2) {
        ...
        if (d1Date == null || d2Date == null) {
            throw new CommonRuntimeException("日期转换出错:" + today + "," + d2);
        }
        if (d1Date.getTime() < d2Date.getTime())
            return true;
        return false;
    ...
    public static int countAfterBirthDays(Date birthday_date) throws ParseException {
        ...
        Date mydate = myFormatter.parse(year + md);
    ...
    public static boolean isBetween(String d1, String d2, String d3, String format) {
        ...
        if (d1Date == null || d2Date == null || d3Date == null) {
            throw new CommonRuntimeException("日期转换出错:" + d1 + "," + d2 + "," + d3);
        }
        if (d1Date.getTime() >= d2Date.getTime()
    ...
    public static List<String> getYearTime(String monthOne, String monthTwo) {
        ...
        Date date1 = toDate(yearTwo);
        Date date2 = toDate(yearOne);

        if (date1 == null || date2 == null) {
            throw new CommonRuntimeException("日期转换出错," + yearTwo + "," + yearOne);
        }
     ...
     * @return
     */
    public static String secondToTimeString(int seconde) {
        if (seconde < 0) {
            return "";
        }
        int time = seconde;
