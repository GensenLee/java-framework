...
public abstract class AssertUtil {
	...
	public static void isTrue(boolean expression, Supplier<String> messageSupplier) {
		if (!expression) {
			throw new CommonRuntimeException(nullSafeGet(messageSupplier));
		}
	}

	/**
	 * Assert a boolean expression, throwing an {@code CommonRuntimeException}
	 * if the expression evaluates to {@code false}.
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws CommonRuntimeException if the object is not {@code null}
	 */
	 ...
	 * @param object the object to check
	 * @param message the exception message to use if the assertion fails
	 * @throws CommonRuntimeException if the object is {@code null}
	 */
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws CommonRuntimeException if the text is empty
	 ...
	 * @param text the String to check
	 * @param message the exception message to use if the assertion fails
	 * @throws CommonRuntimeException if the text does not contain valid text content
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws CommonRuntimeException if the text contains the substring
	 */
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws CommonRuntimeException if the object array is {@code null} or contains no elements
	 */
	 ...
	 * @param array the array to check
	 * @param message the exception message to use if the assertion fails
	 * @throws CommonRuntimeException if the object array contains a {@code null} element
	 */
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws CommonRuntimeException if the collection is {@code null} or
	 ...
	 * @param collection the collection to check
	 * @param message the exception message to use if the assertion fails
	 * @throws CommonRuntimeException if the collection contains a {@code null} element
	 * @since 5.2
	 */
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws CommonRuntimeException if the map is {@code null} or contains no entries
	 */
	 ...
	 * @throws CommonRuntimeException if the object is not an instance of type
	 */
	 ...
	 * @throws CommonRuntimeException if the classes are not assignable
	 */
	...
	private static void instanceCheckFailed(Class<?> type, @Nullable Object obj, @Nullable String msg) {
		...
		throw new CommonRuntimeException(result);
	}
