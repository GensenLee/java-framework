 ...
 */
@Data
public class PolyvChannelUpdateBasicSetting extends BaseBean {
    ...
    public void setMaxViewerRestrict(EnableSetting maxViewerRestrict) {
        if (maxViewerRestrict == null) {
            return;
        }
        this.maxViewerRestrict = maxViewerRestrict.getValue();
    }
