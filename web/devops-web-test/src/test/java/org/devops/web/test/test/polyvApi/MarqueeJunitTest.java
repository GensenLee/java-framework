...
import org.devops.mjar.live.polyv.operator.requester.PolyvChannelCreateMarqueeRequester;
 ...
 * 防录屏跑马灯
 */
@ActiveProfiles({"base", "local"})
public class MarqueeJunitTest extends AbstractJUnit4ServiceAction {
    ...
    public void setMarqee() {
        PolyvChannelCreateMarqueeRequester requester = channelClient().createMarqueeRequest();
        requester.parameter().withMarqueeRestrict("N").withUrl("111");
