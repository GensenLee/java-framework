...
public class AuthMenu extends BaseBean{
	...
	public static List<AuthMenu> init(){
		...
		//1
		list.add(new AuthMenu(1L,"权限设置","/auth-app/list",0L,"","default",1,0,1,0f,"system",now,"system",now));
		
		//2
		list.add(new AuthMenu(1L,"权限设置","#",1L,",1,","default",1,0,1,0f,"system",now,"system",now));
		
		//3
		list.add(new AuthMenu(1L,"系统列表","/auth-app/list",2L,",1,2,","default",1,0,1,0f,"system",now,"system",now));
		
		//4
		list.add(new AuthMenu(1L,"系统实例","/auth-app-instance/list",2L,",1,2,","default",1,0,1,0f,"system",now,"system",now));
		
		//5
		list.add(new AuthMenu(1L,"菜单列表","/auth-menu/list",2L,",1,2,","default",1,0,1,0f,"system",now,"system",now));
		
		//6
		list.add(new AuthMenu(1L,"资源列表","/auth-resources/list",2L,",1,2,","default",1,0,1,0f,"system",now,"system",now));
		
		//7
		list.add(new AuthMenu(1L,"用户列表","/auth-user/list",2L,",1,2,","default",1,0,1,0f,"system",now,"system",now));
		
		//8
		list.add(new AuthMenu(1L,"角色列表","/auth-role/list",2L,",1,2,","default",1,0,1,0f,"system",now,"system",now));
		
		//9
		list.add(new AuthMenu(1L,"集团列表","/auth-company/list",2L,",1,2,","default",1,0,1,0f,"system",now,"system",now));
		
		//10
		list.add(new AuthMenu(1L,"登录日志","/auth-login-log/list",2L,",1,2,","default",1,0,1,0f,"system",now,"system",now));

		//11
		list.add(new AuthMenu(1L,"参数设置","/auth-config/list",0L,"","default",1,0,1,0f,"system",now,"system",now));
		//12
		list.add(new AuthMenu(1L,"参数设置","#",11L,",11,","default",1,0,1,0f,"system",now,"system",now));
		//13
		list.add(new AuthMenu(1L,"参数列表","/auth-config/list",12L,",11,12，","default",1,0,1,0f,"system",now,"system",now));
		return list;
	}
	
	
	public static String initSQL() {
		return ResourceUtil.readResourceAsString("classpath:sql/devops-iweb-auth/auth_menu.sql");
	}
