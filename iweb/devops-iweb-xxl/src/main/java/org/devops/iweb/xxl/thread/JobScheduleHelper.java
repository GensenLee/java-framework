            ...
            public void run() {
                ...
                while (!scheduleThreadToStop) {
                    ...
                    try {
                        ...
                        List<XxlJobInfo> scheduleList = XxlJobAdminConfig.getAdminConfig().getXxlJobInfoRepository().scheduleJobQuery(nowTime + PRE_READ_MS);
                        if (scheduleList!=null && scheduleList.size()>0) {
                            ...
                            // 3、更新trigger信息
//                            for (XxlJobInfo jobInfo: scheduleList) {
//                                XxlJobAdminConfig.getAdminConfig().getXxlJobInfoRepository().update(jobInfo);
//                            }
                            XxlJobAdminConfig.getAdminConfig().getXxlJobInfoRepository().update(scheduleList);
