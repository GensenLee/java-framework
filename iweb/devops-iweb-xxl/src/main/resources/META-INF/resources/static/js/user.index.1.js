$(function() {
	...
	var userListTable = $("#user_list").dataTable({
	    ...
	    "serverSide": true,
		"ajax": {
			url: base_url + "/xxl-user/pageList",
			type:"post",
	        data : function ( d ) {
	        	var obj = {};
	...
	var addModalValidate = $("#addModal .form").validate({
        ...
        submitHandler : function(form) {
        	...
        	$.post(base_url + "/xxl-user/add", paramData, function(data, status) {
    			if (data.code == "200") {
					$('#addModal').modal('hide');
	...
	var updateModalValidate = $("#updateModal .form").validate({
        ...
        submitHandler : function(form) {
            ...
            $.post(base_url + "/xxl-user/update", paramData, function(data, status) {
                if (data.code == "200") {
